...
export const setChatHistoryByCustomerId = payload => ({
    type: actionTypes?.SET_CHAT_HISTORY_BY_CUSTOMER_ID,
    payload
});

export const getCallHistoryByCustomerId = payload => ({
    type: actionTypes?.GET_CALL_HISTORY_BY_CUSTOMER_ID,
    payload
});

export const setCallHistoryByCustomerId = payload => ({
    type: actionTypes?.SET_CALL_HISTORY_BY_CUSTOMER_ID,
    payload
});

export const getVideoCallHistoryByCustomerId = payload => ({
    type: actionTypes?.GET_VIDEO_CALL_HISTORY_BY_CUSTOMER_ID,
    payload
});

export const setVideoCallHistoryByCustomerId = payload => ({
    type: actionTypes?.SET_VIDEO_CALL_HISTORY_BY_CUSTOMER_ID,
    payload
});

export const getLiveHistoryByCustomerId = payload => ({
    type: actionTypes?.GET_LIVE_HISTORY_BY_CUSTOMER_ID,
    payload
});

export const setLiveHistoryByCustomerId = payload => ({
    type: actionTypes?.SET_LIVE_HISTORY_BY_CUSTOMER_ID,
    payload
});
...
export const getOrderHistoryByCustomerId = payload => ({
    type: actionTypes?.GET_ORDER_HISTORY_BY_CUSTOMER_ID,
    payload
});

export const setOrderHistoryByCustomerId = payload => ({
    type: actionTypes?.SET_ORDER_HISTORY_BY_CUSTOMER_ID,
    payload
});

export const getFollowingHistoryByCustomerId = payload => ({
    type: actionTypes?.GET_FOLLOWING_HISTORY_BY_CUSTOMER_ID,
    payload
});

export const setFollowingHistoryByCustomerId = payload => ({
    type: actionTypes?.SET_FOLLOWING_HISTORY_BY_CUSTOMER_ID,
    payload
});

export const getReviewHistoryByCustomerId = payload => ({
    type: actionTypes.GET_REVIEW_HISTORY_BY_CUSTOMER_ID,
    payload
});

export const setReviewHistoryByCustomerId = payload => ({
    type: actionTypes.SET_REVIEW_HISTORY_BY_CUSTOMER_ID,
    payload
});